...
本目录的 9 道公开开发题用于定位 Houdini agent 在读图、整机建模、局部细节、修改后保持和交付判断上的问题。其中旋盖水瓶题观察中空壳体、瓶口封合和面朝向；桌面台钳题观察直线滑动的接触、分离和传动关系；桌面收纳盒题观察转动开合、前缘间隙和铰链连接。它们已可被开发者看到，不能当作未见题证明通用能力。
