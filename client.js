      ...
      for (var i = 0; i < sections.length; i++) {
        ...
        if (s.indexOf("verbs (") === 0) {
          ...
          for (var k = 1; k < lines.length; k++) {
            var m = parseVerbLedgerLine(lines[k]);
            if (m) {
              info.verbs.push({ verb: m.verb, ok: m.ok, argsText: m.argsText, detail: m.detail, ms: m.ms });
            }
          }
